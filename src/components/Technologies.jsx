...
const Technologies = () => {
  const techIcons = [
    { component: FaJava, color: "text-red-600", duration: 2.4 }, // ✅ Java
    ...
    { component: SiMysql, color: "text-blue-600", duration: 2.7 },
     { component: FaDocker, color: "text-blue-400", duration: 2.5 }, // ✅ Docker
    { component: SiDjango, color: "text-green-700", duration: 2.3 },// ✅ Django
  ];
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["HTML", "CSS", "React.js", "Node.js", "Spring Boot", "Django"],
      icon: SiDjango,
    ...
    >
      ...
      >
        {skillCategories.map(({ title, skills, icon: Icon, color }, index) => (
          <div
            key={index}
            className="p-8 bg-gradient-to-r from-purple-800 via-indigo-900 to-blue-900 border border-neutral-700 rounded-2xl shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:scale-105"
          >
            <div className="flex items-center gap-4 mb-4">
              <Icon
                className={`text-4xl ${color} hover:scale-110 transition-all duration-300`}
              />
