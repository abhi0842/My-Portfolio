...
const Education = () => {
  const educationData = [
    {
      id: 1, 
      degree: "Bachelor of Technologyy (B.Tech) in Computer Science and Engineering",
      institution: "Sir Chhotu Ram Institute of Engineering and Technology (SCRIET), Meerut",
      duration: "2020 - 2024",
      CGPA: "CGPA: 8.09/10",
    },
